...
Since SpenT is a static web application, no complex backend installation is required.
...
1.  **Landing Page**: Start at the landing page to understand the core philosophy.
2.  **Dashboard**: Enter the dashboard to see your daily timer counting down.
3.  **Log Tasks**: Use the input fields to add tasks. Categorize them to see your "Invested" vs. "Wasted" metrics update deeply.
4.  **Review Analytics**: Check the Analytics tab to see visual breakdowns of your day.
5.  **Export Data**: Use the "Export Report" feature in Analytics to save a snapshot of your progress.
...
<p align="center">
  Developed with ❤️ for those who value their time.
</p>
